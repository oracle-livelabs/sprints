# Load a pre-built ONNX embedding generation model
...
This LiveLabs FastLab hows you load a pre-built ONNX embedding generation model into an Autonomous AI Database.
...
Check this LiveLabs FastLab to learn how to provision an Autonomous AI Database:
